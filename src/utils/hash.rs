...
// pub fn generate_hash(password: &Secret<String>) -> anyhow::Result<Secret<String>> {
...
// pub fn verify_password(password: &Secret<String>, password_hash: &Secret<String>) -> anyhow::Result<bool> {
